...
//   WriteFile(sock);
  ...
  public static void ReadFile(Socket sock) throws IOException{
        ...
        FileOutputStream out = new FileOutputStream("C:/Users/gianmarco/Desktop/TestconfigurationRecived.xml");
  ...
  public static void ReadDb(Socket sock) throws IOException{

	 
	    DataInputStream dis = new DataInputStream(sock.getInputStream()); //get the socket's input stream
        int size = dis.readInt(); //get the size of the file.
        InputStream in = sock.getInputStream(); 
        FileOutputStream out = new FileOutputStream("C:/Users/gianmarco/Desktop/TestdbRecived.db");
        int totalBytesRead = 0;
  ...
  public static void WriteFile(Socket sock){
	...
	try {
		  File myFile = new File("C:/Users/gianmarco/workspaceKeplar/newRaspiServer/raspiConfiguration.xml");
