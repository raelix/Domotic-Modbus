...
import com.domotica.raspimanager.R.anim;
import com.domotica.raspimanager.R.id;
...
public class ActivityVoiceRecognitions extends Activity implements OnInitListener{
		...
		speech.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(list.size() >= 3){
					...
					listvoice.startAnimation(AnimationUtils.loadAnimation(ActivityVoiceRecognitions.this, R.anim.enter_from_down));
				}
